                    ...
                    <div class="box-center">
                        ...
                        <div class="trade-price d-flex bg-warning-subtle p-3 mt-3">
                            @if ($formattedSalePrice)
                                <!-- Hiển thị giá giảm với giá gốc bị gạch ngang -->
                                <div class="border-end pe-5 me-3">
                                    <div class="price fw-bold text-danger" id="retail-price">{{ $formattedSalePrice }} VNĐ</div>
                                </div>
                                <div>
                                    <div class="price fw-bold"><s>{{ $formattedRegularPrice }} VNĐ</s></div>
                                </div>
                            @else
                                <!-- Chỉ hiển thị giá gốc nếu không có giá giảm -->
                                <div class="border-end pe-5 me-3">
                                    <div class="price fw-bold text-danger" id="retail-price">{{ $formattedRegularPrice }} VNĐ</div>
                                </div>
                            @endif
                        </div>
