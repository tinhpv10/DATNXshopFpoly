...
class ProductMediaPolicy
{
    ...
    {
        return $user->can('view_any_product::media');
    }
    ...
    {
        return $user->can('create_product::media');
    }
    ...
    {
        return $user->can('delete_any_product::media');
    }
    ...
    {
        return $user->can('force_delete_any_product::media');
    }
    ...
    {
        return $user->can('restore_any_product::media');
    }
    ...
    {
        return $user->can('reorder_product::media');
    }
}
